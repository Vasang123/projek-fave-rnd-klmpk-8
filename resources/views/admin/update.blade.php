                ...
                <div class="card-body">
                    <form action="{{url('/items/update/'. $item->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-floating col-md-6">
                                <select id="item_type" class=" form-select form-control @error('item_type') is-invalid @enderror" name="item_type" value="{{ $item->item_type }}" required autocomplete="item_type" autofocus >
